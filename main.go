...
func update(screen *ebiten.Image) error {
	...
	text.Draw(screen, t.CurrentExample(), mplusNormalFont, 100, 100, color.White)
	text.Draw(screen, t.UserString(), mplusNormalFont, 100, 150, color.White)
	text.Draw(screen, t.CurrentTime(), mplusSmallFont, 100, 220, color.White)
